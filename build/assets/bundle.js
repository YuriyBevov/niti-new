...
/***/ "./src/scripts/modules/catalog-item-text-split.js":
/*!********************************************************!*\
  !*** ./src/scripts/modules/catalog-item-text-split.js ***!
  \********************************************************/
...
var items = document.querySelectorAll('.catalog-preview__grid-item');
...
var onMouseEnterHandler = function onMouseEnterHandler(evt) {
  ...
  setTimeout(function () {
    if (item.classList.contains('animation-prepared')) {
      var text = item.querySelector('.catalog-preview__grid-title h3');
      var tl = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
        repeat: -1,
        repeatDelay: 5
      });
      var splitText = new gsap_SplitText__WEBPACK_IMPORTED_MODULE_2__.SplitText(text, {
        type: "words,chars"
      });
...
if (burger && nav) {
  ...
  burger.addEventListener('click', function () {
    ...
    timeline.fromTo('.nav__container', {
      x: '100%',
      opacity: 0
    }, {
      x: 0,
...
/* harmony import */ var _modules_catalog_item_text_split_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/catalog-item-text-split.js */ "./src/scripts/modules/catalog-item-text-split.js");
